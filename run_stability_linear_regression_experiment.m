function [output] = run_stability_linear_regression_experiment(Xtrain, ytrain, Xtest, ytest, ratios, numRuns)
...
for i=1:length(ratios)
    ...
    for j=1:numRuns
        ...
        results = stability_linear_regression(Xtrain, ytrain, Xtest, ytest, ratio);
