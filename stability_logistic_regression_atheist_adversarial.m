...
Xtrain = X(C.test(2),:);
ytrain = y(C.test(2));
output=run_stability_logistic_regression_experiment_adversarial(Xtrain, ytrain, Xtest, ytest, [0.0,0.005,0.01,0.015,0.02,0.025,0.03,0.035,0.04,0.045,0.05], 20, 'atheistLRFinemodel.mat',0);
